...
bool is_operator(int ptr)
{
  ...
  return type == '+' || type == '-' || type == '*' || type == '/' || type == TK_EQ || type == TK_NEQ || type == TK_AND || type == TK_DEREF;
}
...
{
  int type = tokens[ptr].type;
  return type == '+' || type == '-' || type == '*' || type == '/' || type == TK_EQ || type == TK_NEQ || type == TK_AND || type == '(';
}
